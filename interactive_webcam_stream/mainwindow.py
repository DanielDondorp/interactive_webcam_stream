...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionset_n_images = QtWidgets.QAction(MainWindow)
        self.actionset_n_images.setObjectName("actionset_n_images")
        self.actionclear_all_training_data = QtWidgets.QAction(MainWindow)
        self.actionclear_all_training_data.setObjectName("actionclear_all_training_data")
        self.menuFile.addAction(self.actionsetWorkingDir)
        self.menuFile.addAction(self.actionset_n_images)
        self.menuFile.addAction(self.actionclear_all_training_data)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menuFile.setTitle(_translate("MainWindow", "co&nfig"))
        self.actionsetWorkingDir.setText(_translate("MainWindow", "&setWorkingDir"))
        self.actionset_n_images.setText(_translate("MainWindow", "set_n_images"))
        self.actionclear_all_training_data.setText(_translate("MainWindow", "clear_all_training_data"))
